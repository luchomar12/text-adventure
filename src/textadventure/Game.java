...
public class Game {
    ...
    public void init() {
        ...
        //INICIALIZO ITEMS
        Item llave = new Item("Llave", "Una pesada llave de plata. Parece abrir algo importante", false);
        Item soga = new Item("Soga", "Una soga fina. Se podría atar a algo", false);
        Item nota = new Item("Nota", "Una nota con unos números: 438", true);
        Item tablero = new Item("Tablero", "Un tablero donde puedes ingresar números.", true);
        Item cofre = new Item("Cofre", "Un cofre mediano de madera, tiene una cerradura", true);
    ...
    public static void showRoom() {
        ...
        if (p.getPlayerRoom().getItems().isEmpty()) { //Muestro los objetos de la habitación, si los hay
            ...
            for (Item item : p.getPlayerRoom().getItems()) {
