...
public class Contenedor extends Item implements Interactuable, Abrible {
    ...
    //CONSTRUCTOR
    public Contenedor(int code, String name, String description) {
    ...
    public void getTreasures() {
        for (Guardable treasure : treasures) {
            ...
            juego.getPlayer().inventory.add(treasure); //Agrego los tesoros al inventario
        }
    }
    ...
    public void interact() {
        if (this.getInteractuable() == null) { // si NO tiene interactuable tiene llave
            ...
            System.out.println("");
            if (juego.getPlayer().inventory.isEmpty()) {
